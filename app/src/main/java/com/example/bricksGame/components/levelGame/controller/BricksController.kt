...
////    }
//
//    fun createBricksList(level: Level): MutableList<BrickType.Brick> {
////        val bricksList: MutableList<BrickType.Brick> = mutableListOf()
...
//    }
//
//    private fun createBrick(level: Level): BrickType.Brick {
////        val newBrick = BrickType.Brick(
